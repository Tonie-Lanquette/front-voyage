...
export const Footer = () => {
  ...
  return (
        <div className="flex w-full  items-center justify-end py-2 px-10 bg-green-950 lg:py-4 shadow-md text-white ">
                ...
                <div> 
                     ...
                     <ul>
                        ...
                        window.open('/politiquedeconfidentialite')}}>
                            Pioultique de confidentialité
                            </button>
                        </li>
                        <li className='list-disc mb-2'>
                            <button className="ms-2" onClick={() => {
                        window.open('/nouscontacter')}}>
                            Nous contacter
                            </button>
                        </li>
                     </ul>
